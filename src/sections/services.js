...
const SERVICES_DATA = [
  {
    ...
    title: 'Transparency',
    text:
      'A clear money trail to follow.',
  },
  {
    icon: icon2,
    title: 'Direct Communication',
    text:
      'Partners communicate directly with no intermediaries involved.',
  },
  {
    icon: icon3,
    title: 'Cost Efficiency',
    text:
      'A significant reduction in costs to organize the sale and collect money afterward.',
  },
  {
    icon: icon4,
    title: 'Smart Contract Technology',
    text:
      'Ensure the money raised is spent on what businesses need to pursue rather than wasting funds.',
  },
];
  ...
  return (
    <Box sx={styles.services} id="services">
      <Container>
        <BlockTitle
          slogan="Why Lafeef?"
          title="Lafeef is not just another crowdfunding platform!"
