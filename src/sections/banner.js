      ...
      <Container sx={styles.container}>
        <Grid sx={styles.grid}>
          <Box sx={styles.content}>
            <Heading as="h3">
            Decentralized Crowdfunding and Investment Platform
            </Heading>
            <Text as="p">
            Safe investment opportunities to fund creative and innovative ideas.
            </Text>
...
const styles = {
  ...
  content: {
    h3: {
      ...
      fontSize: [6, null, null, '36px', null, '45px', 9],
    },
    p: {
